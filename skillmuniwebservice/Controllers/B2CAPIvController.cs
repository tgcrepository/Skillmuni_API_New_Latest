...
{
    public class B2CAPIv1Controller : ApiController
    {
        private db_m2ostEntities db = new db_m2ostEntities();

        public HttpResponseMessage Get(int IDS, string VT)
        {
            List<B2CResponse> response = new List<B2CResponse>();
            if (VT == "TYPE1")
            {
                //right answers
                string sql = "select * from tbl_brief_b2c_right_audit where id_brief_b2c_right_audit >" + IDS + " ";
            ...
            {
                //Brief score
                string sql = "SELECT * FROM tbl_brief_b2c_score_audit where id_brief_b2c_score_audit >" + IDS;
            ...
            {
                //Brief Read counter
                string sql = "SELECT * FROM tbl_brief_read_status where read_status=1 and id_brief_read_status > " + IDS;
